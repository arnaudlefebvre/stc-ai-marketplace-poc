...
description: Sharpen ubiquitous language, challenge ambiguous domain terms, align language with code, and record justified modeling decisions during design.
---

<!-- Source: https://github.com/mattpocock/skills/blob/main/docs/engineering/domain-modeling.md (retrieved 2026-09-23). AI-assisted marketplace packaging; human review required. -->
