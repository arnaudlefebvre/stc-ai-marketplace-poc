---
name: wayfinder
description: Plan multi-session engineering efforts as decision maps, resolve uncertainty through decision tickets, and hand off to implementation when the route is clear.
---

<!-- Source: https://github.com/mattpocock/skills/blob/main/docs/engineering/wayfinder.md (retrieved 2026-09-23). AI-assisted marketplace packaging; human review required. -->
